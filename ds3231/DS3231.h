/*!
 * @file DS3231.h
 * @brief DS3231 Class is by Seeed Technology Inc(http://www.seeedstudio.com) and used
 * @fn in Seeeduino Stalker v2.1 for battery management(MCU power saving mode)
 * @fn& to generate timestamp for data logging. DateTime Class is a modified
 * @fnversion supporting day-of-week.
